...
An end-to-end e-commerce data warehouse and business intelligence pipeline analyzing over 21 million session records from the Google Merchandise Store.
...
* **8** SQL Analytics Scripts (Deduplication, Funnels, Geo Friction, Product Performance, Exit Paths, Star Schema, RFM Segments, BQML Propensity)
